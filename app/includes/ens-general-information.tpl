  ...
  <div class="cont-md">
    ...
    <h4> What is the process like? </h4>
      ...
      <ul ng-show="ensPrep">
        ...
        <li>
          Decide the maximum amount of ETH you are willing to pay for the name (your <u>Bid Amount</u>). Ensure that account has enough to cover your bid + 0.01 PIRL for gas.
        </li>
      </ul>
