  ...
  <div class="cont-md">
    ...
    <h4> What is the process like? </h4>
      ...
      <ul ng-show="ensPrep">
        ...
        <li> Decide the maximum amount of ETH you are willing to pay for the name (your <u>Bid Amount</u>). Ensure that account has enough to cover your bid + 0.01 PIRL for gas.</li>
      </ul>
      ...
      <ul ng-show="ensFinalize">
        ...
        <li> The winner will be refunded the difference between their bid and the next-highest bid. If you are the only bidder, you will refunded all but 0.01 PIRL. </li>
      </ul>
