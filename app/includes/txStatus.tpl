    ...
    <table class="table table-striped txstatus__2 cont-md"> <!-- ng-show="tx.status=='foundOnChain' || foundInPending'"-->
      <tbody>
        <tr>
          ...
          <td><a href="https://poseidon.pirl.io/explorer/transaction/{{ txInfo.hash }}" target="_blank" rel="noopener"> {{ txInfo.hash }} </a></td>
        </tr>
        <tr>
          <td translate="OFFLINE_Step1_Label_1">From Address</td>
          <td><!-- <a href="https://poseidon.pirl.io/explorer/address/{{ txInfo.from }}" target="_blank" rel="noopener"> --> {{ txInfo.from }} <!-- </a> --></td>
        </tr>
        <tr>
          <td translate="OFFLINE_Step2_Label_1">To Address</td>
          <td><!-- <a href="https://poseidon.pirl.io/explorer/address/{{ txInfo.to }}" target="_blank" rel="noopener"> --> {{ txInfo.to }} <!-- </a> --></td>
        </tr>
        <tr>
