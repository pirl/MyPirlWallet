...
/* Onboarding */
ONBOARD_welcome_title           :  'Welcome to wallet.pirl.io',
...
ONBOARD_welcome_content__4      :  'What is MPW? ',
ONBOARD_welcome_content__5      :  'MyPirlWallet is a free, open-source, client-side interface.',
...
ONBOARD_bank_title              :  'MyPirlWallet is not a Bank',
...
ONBOARD_interface_title         :  'MyPirlWallet is an Interface',
ONBOARD_interface_content__1    :  'When you create an account on MyPirlWallet you are generating a cryptographic set of numbers: your private key and your public key (address).',
...
ONBOARD_blockchain_content__4   :  'The blocks in the blockchain are made up of all the individual transactions sent from MyPirlWallet, MetaMask, Exodus, Mist, Geth, Parity, and everywhere else.',
ONBOARD_blockchain_content__5   :  'When you see your balance on wallet.pirl.io or view your transactions on [Pirl Poseidon](https://poseidon.pirl.io/explorer), you are seeing data on the blockchain, not in our personal systems.',
ONBOARD_blockchain_content__6   :  'Again: **we are not a bank**.',
ONBOARD_interface_title__alt    :  'MPW is an Interface',
...
ONBOARD_blockchain_title__alt   :  'WTF is a Blockchain?',
ONBOARD_point_title__alt        :  'What\'s the Point of MPW then?',
ONBOARD_whymew_title            :  'If MyPirlWallet can\'t do those things, what\'s the point?',
...
ONBOARD_whymew_content__6       :  'If you are scared but want to use MPW, [get a hardware wallet](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.',
...
ONBOARD_secure_1_content__3     :  'Always check the URL: `https://wallet.pirl.io`.',
...
ONBOARD_final_content__3        :  'How to Set up MPW + MetaMask',
ONBOARD_final_content__4        :  'How to Run MPW Offline / Locally',
...
/* Old */
ADD_DigitalBitbox_0a            :  'Re-open MyPirlWallet on a secure (SSL) connection',
ADD_DigitalBitbox_0b            :  'Re-open MyPirlWallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/)',
ADD_DigitalBitbox_scan          :  'Connect your Digital Bitbox',
ADD_Secalot_0a              : 'Re-open MyPirlWallet on a secure (SSL) connection ',
ADD_Secalot_0b              : 'Re-open MyPirlWallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
ADD_Ledger_0a                   :  'Please use MyPirlWallet on a secure (SSL / HTTPS) connection to connect.',
ADD_Ledger_0b                   :  'Re-open MyPirlWallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/)',
...
GEN_Help_12                     :  'Use it to unlock your wallet via MyPirlWallet (or Mist, Geth, Parity and other wallet clients.)',
...
MEW_Tagline                     :  'Open Source JavaScript Client-Side Pirl Wallet',
...
MYWAL_Content_3                 :  'If you want to use this wallet with your MyPirlWallet CX in the future, you will need to manually re-add it using the private key/JSON and password.',
MYWAL_Edit                      :  'Edit',
...
NODE_Warning                    :  'Your node must be HTTPS in order to connect to it via wallet.pirl.io. You can [download the MyPirlWallet repo & run it locally](https://git.pirl.io/community/MyPirlWallet) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
...
tx_notFound_4                   :  'Please use the dropdown in the top-right & select a different PIRL node and check again.',
...
x_Access                        :  'Access',
x_AddessDesc                    :  'Your Address can also be known as you `Account #` or your `Public Key`. It is what you share with people so they can send you Pirl or Tokens. Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere.',
